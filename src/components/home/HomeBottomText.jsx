...
useGSAP(() => {
  ...
  return (
    <div className='overflow-hidden pb-2 font-[font2] flex items-center  justify-center gap-2 '>
      <div className='link1 lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-26 lg:pb-3 lg:pt-0 pt-1 flex items-center px-3 lg:px-14 border-white rounded-full uppercase'>
        <Link className=' text-[6vw] lg:mt-6' to='/projects'>Projects</Link>
      </div>
      <div className='link2 lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50]  lg:h-26 lg:pb-3 lg:pt-0 pt-1 flex items-center px-3 lg:px-14 border-white rounded-full uppercase'>
